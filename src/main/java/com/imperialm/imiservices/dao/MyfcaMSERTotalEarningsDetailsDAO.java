...
public interface MyfcaMSERTotalEarningsDetailsDAO {
	...
	public static String SELECT_DEALERCOUNT_BY_BC_OR_DISTRICT = "Select (Enrolled_Dealers) total, 'Total Dealers Enrolled' as 'name', '' as error From (Select MG.Parent, COUNT( DISTINCT Dealercode) Enrolled_Dealers From MyfcaMSERTotalEarningsDetails MGD INNER JOIN MyfcaMSERTotalEarnings MG ON MG.Child=MGD.DealerCode Where DealersEnrolled > 0 and MG.Parent like ?0 Group by MG.Parent) A";
