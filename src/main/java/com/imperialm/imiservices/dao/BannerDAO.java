...
public interface BannerDAO {
	...
	public static String BANNERS_BY_ROLE_AND_TERRITORY = "Select distinct FileName 'fileName', Name 'name', bm.OrderBy 'orderBy' from banners b join [BannerMappings] bm on b.ID = bm.bannerid where b.DelFlag = 'N' and bm.RoleID = ?0 and bm.BusinessCenter = ?1 order by bm.OrderBy";
	...
	//spublic List<ImagesDTO> getBannersByRole(int roleId, String territory);
