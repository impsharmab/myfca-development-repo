...
public interface MSEREarningsDAO {
	public static String EARNING_BY_ROLE = "select TOP 5 ER.Territory, [Mopar Parts] 'moparParts', mvp, [Magneti Marelli] 'magnetiMarelli', [Parts Counter] 'partsCounter', [Express Lane] 'expressLane', wiAdvisor, uConnect  from [MSER Earnings] ER";
