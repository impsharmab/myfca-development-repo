...
public interface RewardRedemptionDetailsDAO {
	...
	public static String GET_DETAILS_BY_SID_AND_DEALERCODE_CCP_BB = "SELECT  [DealerCode] 'dealerCode', '' as 'dealerName', [SID] 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where [SID] = ?0 and DealerCode = ?1 and (Program like 'CCP' OR Program like 'BRAINBOOST') group by dealerCode, [SID]";
	public static String GET_DETAILS_BY_DEALERCODE_CCP_BB = "SELECT  [DealerCode] 'dealerCode', '' as 'dealerName', '' as 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where DealerCode = ?0 and (Program like 'CCP' OR Program like 'BRAINBOOST') group by dealerCode";
	public static String GET_DETAILS_BY_SID_AND_DEALERCODE_TTTA = "SELECT  [DealerCode] 'dealerCode', '' as 'dealerName', [SID] 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where [SID] = ?0 and DealerCode = ?1 and (Program like 'TOPTECH' OR Program like 'TOPADVISOR') group by dealerCode, [SID]";
	public static String GET_DETAILS_BY_DEALERCODE_TTTA = "SELECT  [DealerCode] 'dealerCode', '' as 'dealerName', '' as 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where DealerCode = ?0 and (Program like 'TOPTECH' OR Program like 'TOPADVISOR') group by dealerCode";
