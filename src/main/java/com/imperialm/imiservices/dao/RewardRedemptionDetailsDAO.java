...
public interface RewardRedemptionDetailsDAO {
	...
	public static String GET_DETAILS_BY_SID = "SELECT '' as 'dealerCode', '' as 'dealerName', '' as 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where [SID] = ?0";
	...
	public static String GET_DETAILS_BY_SID_CCP_BB = "SELECT  '' as 'dealerCode', '' as 'dealerName', '' as 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where [SID] = ?0 and (Program = 'CCP' OR Program = 'BRAINBOOST')";
	...
	public static String GET_DETAILS_BY_SID_TTTA = "SELECT  '' as 'dealerCode', '' as 'dealerName', '' as 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where [SID] = ?0 and (Program = 'TOPTECH' OR Program = 'TOPADVISOR')";
	...
	public static String GET_DETAILS_BY_DEALERCODE_TTTA = "SELECT  '' as 'dealerCode', '' as 'dealerName', '' as 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [RewardRedemptionDetails] where DealerCode = ?0 and (Program = 'TOPTECH' OR Program = 'TOPADVISOR') group by dealerCode";
