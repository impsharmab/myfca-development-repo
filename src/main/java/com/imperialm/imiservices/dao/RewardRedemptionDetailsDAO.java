...
public interface RewardRedemptionDetailsDAO {
	...
	public static String GET_DETAILS_BY_DEALERCODE_CCP_BB = "SELECT  [DealerCode] 'dealerCode', '' as 'dealerName', [SID] 'sID', '' as 'name', SUM([EarnedPoints]) 'earnedPoints', SUM([RedeemedPoints]) 'redeemedPoints', SUM([BalancePoints]) 'balancePoints','' as error FROM [dbo].[RewardRedemptionDetails] where DealerCode = ?0 and (Program like 'CCP' OR Program like 'BRAINBOOST') group by dealerCode";
