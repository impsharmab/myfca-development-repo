...
public interface MyFCAMserRankingDAO {
	...
	public static String SELECT_BY_CHILD = "SELECT [Parent] 'parent' ,[Child] 'child' ,[EarningsMTD] 'earningsMTD' ,[BCRank] 'bCRank' FROM [MyFCAMserRanking] where [Child] like ?0 order by [Parent], [Child]";
