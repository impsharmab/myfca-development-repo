...
public interface CertProfsWinnersDetailsDAO {
	...
	public static String SELECT_BY_DEALER_CODE_GROUP_BY_SID = "SELECT [DealerCode] 'dealerCode' ,[DealerName] 'dealerName' ,[SID] 'sID' ,[Name] 'name' , '' as 'certType' , SUM([Points]) 'points' ,SUM([Certified]) 'certified' ,SUM([CertifiedSpecialist]) 'certifiedSpecialist' ,SUM([MasterCertified]) 'masterCertified' ,SUM([TotalCertified]) 'totalCertified' ,ISNULL(SUM([YearsOfCertified]), 0) 'yearsOfCertified' , '' as priorYearCertLevel , '' as error FROM [dbo].[CertProfsWinnersDetails] where DealerCode = ?0 group by [DealerCode] ,[DealerName] ,[SID] ,[Name]";
	public static String SELECT_BY_SID = "SELECT [DealerCode] 'dealerCode' ,[DealerName] 'dealerName' ,[SID] 'sID' ,[Name] 'name' ,[CertType] 'certType' ,[Points] 'points' ,[Certified] 'certified' ,[CertifiedSpecialist] 'certifiedSpecialist' ,[MasterCertified] 'masterCertified' ,[TotalCertified] 'totalCertified' , ISNULL([YearsOfCertified], 0) 'yearsOfCertified' , [PriorYearCertLevel] priorYearCertLevel, '' as error FROM [dbo].[CertProfsWinnersDetails] where [SID] = ?0 AND [DealerCode] = ?1";
