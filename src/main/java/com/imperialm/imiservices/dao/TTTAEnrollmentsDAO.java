...
public interface TTTAEnrollmentsDAO {
	...
	public static String SELECT_BY_SID = "SELECT [DealerCode] 'sealerCode' ,[DealerName] 'sealerName' ,[SID] 'sID' ,[Name] 'name' ,[Enrollment] 'enrollment' ,[PositionCode] 'positionCode' ,[IncentiveEligible] 'incentiveEligible', [AvgSurveyScore] 'avgSurveyScore' ,[SurveyCount] 'surveyCount', [Level3Techs] 'level3Techs', [PartcipantRank] 'partcipantRank' ,[YearsOfService] 'yearsOfService' FROM [dbo].[TTTAEnrollments] where SID = ?0 and PositionCode = ?1";
	public static String SELECT_BY_DEALERCODE = "SELECT [DealerCode] 'sealerCode' ,[DealerName] 'sealerName' ,[SID] 'sID' ,[Name] 'name' ,[Enrollment] 'enrollment' ,[PositionCode] 'positionCode' ,[IncentiveEligible] 'incentiveEligible', [AvgSurveyScore] 'avgSurveyScore' ,[SurveyCount] 'surveyCount', [Level3Techs] 'level3Techs', [PartcipantRank] 'partcipantRank' ,[YearsOfService] 'yearsOfService' FROM [dbo].[TTTAEnrollments] where DealerCode = ?0 and PositionCode = ?1";
