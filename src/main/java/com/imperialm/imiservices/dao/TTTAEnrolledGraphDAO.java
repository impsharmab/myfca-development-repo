...
public interface TTTAEnrolledGraphDAO {
	...
	public static String SELECT_BY_PARENT = "SELECT [Parent] 'parent', [Child] 'child', [Total] 'enrolled' ,[Total Group A] 'totalGroupA', [Total Group B] 'totalGroupB', [Total Group C] 'totalGroupC', [Total Group D] 'totalGroupD' ,[Total Group E] 'totalGroupE' FROM [dbo].[GroupTTTAEnrolledGraph] where Parent IN (?0) and toggle = 'Enrolled'";
	public static String SELECT_BY_TERRITORY = "SELECT [Parent] 'parent', [Child] 'child', [Total] 'enrolled' ,[Total Group A] 'totalGroupA', [Total Group B] 'totalGroupB', [Total Group C] 'totalGroupC', [Total Group D] 'totalGroupD' ,[Total Group E] 'totalGroupE' FROM [dbo].[GroupTTTAEnrolledGraph] where Child like ?0 and toggle = 'Enrolled'";
