...
public interface BrainBoostWinndersGraphDAO {
	...
	public static String SELECT_BY_CHILD_TERRITORY_SINGLE = "SELECT [Parent] 'parentTerritory' ,[Child] 'childTerritory' , [Points] 'points' , [Partcipants] 'partcipants', [Winners] 'winners', [Earnings] 'earnings', '' as error FROM [dbo].[BrainBoostWinnersGraph] WHERE [Child] like ?0";
