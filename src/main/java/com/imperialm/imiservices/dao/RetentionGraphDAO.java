...
public interface RetentionGraphDAO {
	...
	public static String SELECT_NAT_BY_POSITIONCODE = "select 'NAT' as parentTerritory,'NAT' as childTerritory , PositionCode 'positionCode', ((CAST(sum(EndingPopulation) as DECIMAL)/(CAST(sum(BeginingPopulation) as DECIMAL)))*100) 'percentage', '' as error from dbo.RetentionGraph where parent = 'nat' and PositionCode = ?0 group by PositionCode";
