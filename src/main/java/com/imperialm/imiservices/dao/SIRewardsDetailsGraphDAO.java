...
public interface SIRewardsDetailsGraphDAO {
	...
	public static String SELECT_BY_PARENT_TERRITORY_AND_TOGGLE = "SELECT [Parent] 'parentTerritory', [Child] 'childTerritory', [Toggle] 'toggle', [AvgSurveyScore] 'avgSurveyScore', [ProjectedEarnings] 'projectedEarnings', [BCDlearRankEarnings] bCDlearRankEarnings, [IncentiveQualified] 'incentiveQualified' ,[TrainingQualified] 'trainingQualified' ,[EligibleSurveys] 'eligibleSurveys' ,[TotalSurveys] 'totalSurveys' FROM [dbo].[SIRewardsDetailsGraph] where [Parent] LIKE ?0 AND [Toggle] LIKE ?1";
	public static String SELECT_SUM_BY_PARENT_TERRITORY_AND_TOGGLE = "SELECT [Parent] 'parentTerritory', '' 'childTerritory', '' 'toggle', SUM([AvgSurveyScore]) 'avgSurveyScore', SUM([ProjectedEarnings]) 'projectedEarnings', 0 bCDlearRankEarnings, SUM([IncentiveQualified]) 'incentiveQualified' , SUM([TrainingQualified]) 'trainingQualified' , SUM([EligibleSurveys]) 'eligibleSurveys' , SUM([TotalSurveys]) 'totalSurveys' FROM [dbo].[SIRewardsDetailsGraph] where [Parent] LIKE ?0 AND [Toggle] LIKE ?1 group by parent";
	public static String SELECT_BY_PARENT_TERRITORY_LIST_AND_TOGGLE = "SELECT [Parent] 'parentTerritory', [Child] 'childTerritory', [Toggle] 'toggle', [AvgSurveyScore] 'avgSurveyScore', [ProjectedEarnings] 'projectedEarnings', [BCDlearRankEarnings] bCDlearRankEarnings, [IncentiveQualified] 'incentiveQualified' ,[TrainingQualified] 'trainingQualified' ,[EligibleSurveys] 'eligibleSurveys' ,[TotalSurveys] 'totalSurveys' FROM [dbo].[SIRewardsDetailsGraph] where [Parent] IN (?0) AND [Toggle] LIKE ?1";
	public static String SELECT_BY_CHILD_TERRITORY_LIST_AND_TOGGLE = "SELECT [Parent] 'parentTerritory', [Child] 'childTerritory', [Toggle] 'toggle', [AvgSurveyScore] 'avgSurveyScore', [ProjectedEarnings] 'projectedEarnings', [BCDlearRankEarnings] bCDlearRankEarnings, [IncentiveQualified] 'incentiveQualified' ,[TrainingQualified] 'trainingQualified' ,[EligibleSurveys] 'eligibleSurveys' ,[TotalSurveys] 'totalSurveys'  FROM [dbo].[SIRewardsDetailsGraph] where [Child] IN (?0) AND [Toggle] LIKE ?1";
	public static String SELECT_BY_CHILD_TERRITORY_LIST_AND_TOGGLE_SINGLE = "SELECT [Parent] 'parentTerritory', [Child] 'childTerritory', [Toggle] 'toggle', [AvgSurveyScore] 'avgSurveyScore', [ProjectedEarnings] 'projectedEarnings', [BCDlearRankEarnings] bCDlearRankEarnings, [IncentiveQualified] 'incentiveQualified' ,[TrainingQualified] 'trainingQualified' ,[EligibleSurveys] 'eligibleSurveys' ,[TotalSurveys] 'totalSurveys'  FROM [dbo].[SIRewardsDetailsGraph] where [Child] like ?0 AND [Toggle] LIKE ?1";
	public static String SELECT_BY_PARENT_TERRITORY_LIST_AND_TOGGLE_DISTICT_PARENT = "SELECT [Parent] 'parentTerritory', '' as 'childTerritory', '' as 'toggle', SUM([AvgSurveyScore]) 'avgSurveyScore', SUM([ProjectedEarnings]) 'projectedEarnings', SUM([BCDlearRankEarnings]) 'bCDlearRankEarnings', SUM([IncentiveQualified]) 'incentiveQualified' , SUM([TrainingQualified]) 'trainingQualified' , SUM([EligibleSurveys]) 'eligibleSurveys' , SUM([TotalSurveys]) 'totalSurveys'  FROM [dbo].[SIRewardsDetailsGraph] where [Parent] IN (?0) AND [Toggle] LIKE ?1 GROUP BY [Parent]";
