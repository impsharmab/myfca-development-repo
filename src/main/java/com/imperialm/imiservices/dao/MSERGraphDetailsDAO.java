...
public interface MSERGraphDetailsDAO {
	...
	public static String SELECT_DEALERCOUNT_BY_BC_OR_DISTRICT = "Select Count(Enrolled_Dealers) total, 'Dealers Count' as 'name', '' as error From (Select MG.Parent, COUNT( DISTINCT Dealercode) Enrolled_Dealers From MSERGraphDetails MGD INNER JOIN MSERGraph MG ON MG.Child=MGD.DealerCode Where DealersEnrolled > 0 and MG.Parent like ?0 Group by MG.Parent) A";
