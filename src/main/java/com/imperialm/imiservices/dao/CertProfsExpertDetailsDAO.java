...
public interface CertProfsExpertDetailsDAO {
	...
	public static String SELECT_SUM_BY_SID_AND_CERT_TYPE = "SELECT '' as 'dealerCode' ,'' as 'dealerName' , '' as 'sID' ,'' as 'name' ,'' as 'certType' ,SUM([Points]) 'points' ,SUM([Cert]) 'cert' ,SUM([TotalPoints]) 'totalPoints'FROM [CertProfsExpertDetails] where [SID] = ?0 AND CertType LIKE ?1";
	public static String SELECT_SUM_BY_SID_AND_DEALER = "SELECT '' as 'dealerCode' ,'' as 'dealerName' ,[SID] 'sID' ,'' as 'name' ,'' as 'certType' ,SUM([Points]) 'points' ,SUM([Cert]) 'cert' ,SUM([TotalPoints]) 'totalPoints'FROM [CertProfsExpertDetails] where [SID] = ?0 AND [DealerCode] = ?1 GROUP BY [SID]";
	public static String SELECT_BY_SID_SUM = "SELECT '' as 'dealerCode' ,'' as 'dealerName' , '' as 'sID' ,'' as 'name' ,'' as 'certType' ,SUM([Points]) 'points' ,SUM([Cert]) 'cert' ,SUM([TotalPoints]) 'totalPoints'FROM [CertProfsExpertDetails] where [SID] = ?0";
