...
public interface BrainBoostWinnersDetailsDAO {
	...
	public static String SELECT_BY_SID = "SELECT [DealerCode] 'dealerCode' ,[DealerName] 'dealerName' ,[SID] 'sID' ,[Name] 'name' ,[Toggle] 'toggle' ,[Points] 'points' ,[Partcipants] 'partcipants' ,[Winners] 'winners' ,[Earnings] 'Earnings' FROM [dbo].[BrainBoostWinnersDetails] where [SID] = ?0 AND Toggle = ?1";
