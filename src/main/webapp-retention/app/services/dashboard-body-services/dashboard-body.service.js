...
var DashboardBodyService = (function () {
    ...
    DashboardBodyService.prototype.getNumberOfTiltes = function () {
        ...
        //  var getNumberOfTilesServiceUrl: string = "http://localhost:9090/imiservices/services/notile/" + positioncodes + "/" + dealerlcodes;
    ...
    DashboardBodyService.prototype.getTilteJson = function (id) {
        ...
        //  var tileService = "http://localhost:9090/imiservices/services/tile/" + id + "/" + positioncodes + "/" + dealerlcodes;
    ...
    DashboardBodyService.prototype.getChartJson = function (id) {
        ...
        //  var chartService = "http://localhost:9090/imiservices/services/tile/" + id + "/" + positioncodes + "/" + dealerlcodes;
