...
export class DashboardBodyService {
    ...
    getNumberOfTiltes() {
       ...
       //  var getNumberOfTilesServiceUrl: string = "https://test.myfcarewards.com/newDBmyfcarewards/services/notile/" + positioncodes + "/" + dealerlcodes;
    ...
    getTilteJson(id?) {
      ...
      //  var tileService = "https://test.myfcarewards.com/newDBmyfcarewards/services/tile/" + id + "/" + positioncodes + "/" + dealerlcodes;
    ...
    getChartJson(id?) {
       ...
       // var chartService = "https://test.myfcarewards.com/newDBmyfcarewards/services/tile/" + id + "/" + positioncodes + "/" + dealerlcodes;
